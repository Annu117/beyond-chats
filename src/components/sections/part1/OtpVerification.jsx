        ...
        <div className="flex justify-center space-x-3">
          {otp.map((digit, index) => (
            <input
              ...
              className="w-12 h-12 text-indigo-500 text-center text-lg font-semibold border-2 rounded-lg focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 outline-none transition-all bg-deep-gray border-muted-indigo-500"
            />
          ))}
        </div>
